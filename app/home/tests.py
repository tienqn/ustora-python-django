...
class HomeTestCase(TestCase):
    ...
    def test_can_access_homepage(self):
        ...
        self.assertEqual(response.context['recently_viewed'][0].product_id.title, 'Samsung gallaxy note 4')
        self.assertEqual(response.context['recently_viewed'][1].product_id.title, 'Nokia Lumia 1320')
        self.assertEqual(response.context['recently_viewed'][2].product_id.title, 'Sony microsoft')
...
class CartTest(TestCase):
    def setUp(self):
        self.product01 = Product.objects.create(title='Samsung gallaxy note 4', img='img/product-6.jpg', origil_price=400, sell_price=400, sold_count=10)
        self.product02 = Product.objects.create(title='iPhone 6', img='img/product-5.jpg', origil_price=1355, sell_price=1200, sold_count=10)
